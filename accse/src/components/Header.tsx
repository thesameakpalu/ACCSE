              ...
              `} >
                <div className="flex justify-between 2xl:justify-center 2xl:gap-[1200px] px-10 md:py-2 lg:py-3 2xl:py-6 items-center  bg-white shadow-[0_0px_5px_rgba(0,0,0,0.2)]"> {/*SOCIAL MEDIA ICONS AND DONATE BUTTON */}
                         ...
                         <div className='flex h-5 md:gap-1 '> 
                                        {/*FACEBOOK ICON */}
                                        <a href="https://www.facebook.com/share/1BNLbu845R/" target="_blank" rel="noopener noreferrer" >
                                        ...
                                        {/*INSTAGRAM ICON */}
                                        <a  href="https://www.instagram.com/ccseghana?igsh=bHlkam9yYm95OHp0&utm_source=qr" target="_blank" rel="noopener noreferer" >
                                        <svg className='h-6 md:h-7 2xl:h-10' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48">
                                        ...
                                        {/*X ICON */}
                                        <a href="https://x.com/ccseghana?s=21" target="_blank" rel="noopener noreferrer" >
                                        ...
                                        {/*LINKEDIN ICON */}
                                        <a href="https://www.linkedin.com/company/ccseghana/" target="_blank" rel="noopener noreferrer" >
                                        <svg className='h-6 md:h-7 2xl:h-10' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48">
